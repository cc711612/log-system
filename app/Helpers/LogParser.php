            ...
            switch ($serviceType) {
                case '1115':
                    ...
                    foreach ($patterns as $pattern){
                        ...
                        return [
                            ...
                            'url'               => $matches['url'] ? urlencode($matches['url']) : '-',
                            ...
                            'referer'           => $matches['referer'] ? urlencode($matches['referer']) : '-',
                ...
                case '1028':
                    ...
                    return [
                        ...
                        'rt'           => $matches[4],
                        'method'       => $matches[5],
                        'url'          => $matches[6] ? urlencode($matches[6]) : '-',
                        ...
                        'pic_bt'       => $matches[12],
                        'tru'          => $matches[13],
                        'referer'      => $matches[14] ? urlencode($matches[14]) : '-',
                        'ua'           => $matches[15],
                    ];
                ...
                case '1551':
                    ...
                    return [
                        ...
                        'code'         => $matches[8],
                        'size'         => $matches[9],
                        'referer'      => $matches[10] ? urlencode($matches[10]) : '-',
                        'ua'           => $matches[11],
                        'aty'          => $matches[12],
                        'ra'           => $matches[13],
